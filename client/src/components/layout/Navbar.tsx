      ...
      {currentUser && (
        <div className="flex items-center gap-4">
          <div className="relative" ref={statusRef}>
            ...
            {isStatusOpen && (
              <div className="absolute right-0 mt-2 w-64 rounded-lg bg-white border border-gray-200 p-1.5 shadow-xl z-50 text-left">
                {STATUS_OPTIONS.map((option) => {
                  const isSelected =
                    currentUser.status_mode === "auto"
                      ? option.id === "auto"
                  ...
                  return (
                    <button
                      ...
                      className="w-full flex items-center justify-between px-3 py-2 rounded-md hover:bg-gray-100 active:bg-gray-200 transition text-left group"
                    >
